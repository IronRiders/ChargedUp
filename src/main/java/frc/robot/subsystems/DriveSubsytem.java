...
public class DriveSubsytem extends SubsystemBase {
    ...
    public DriveSubsytem() {
        ...
        field = new Field2d();
        wheelPositions = new MecanumDriveWheelPositions(motors[0].getWheelPostions(), motors[1].getWheelPostions(),
                motors[2].getWheelPostions(), motors[3].getWheelPostions());
        poseEstimator = new MecanumDrivePoseEstimator(getKinematics(), pigeon.getRotation2d(), wheelPositions,
                new Pose2d());
    }
    ...
    public void setChassisSpeeds(double strafe, double drive, double turn, boolean needPID) {
       ...
       ChassisSpeeds chassisSpeeds = ChassisSpeeds.fromFieldRelativeSpeeds(xSpeed, ySpeed, turnSpeed, pigeon.getRotation2d());
