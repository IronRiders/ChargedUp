...
public class Rotate180Command extends CommandBase {
    ...
    public void initialize() {
        this.initialHeading = driveSubsytem.getYaw();
        SmartDashboard.putNumber("Initial Yaw", driveSubsytem.getYaw());
    ...
    public boolean isFinished() {
        double yaw = Math.abs(driveSubsytem.getYaw() - initialHeading);
