    ...
    public SequentialCommandGroup place() {
        return new SequentialCommandGroup(
                new InstantCommand(
                        ...
                        pivot),
                new WaitCommand(1.2),
                new StartEndCommand(arm::extend, arm::stop, arm).withTimeout(1.65),
                new StartEndCommand(manipulator::release, manipulator::stop, manipulator).withTimeout(0.3));
    }

    public SequentialCommandGroup PlaceAndbalance() {
        return new SequentialCommandGroup(
                place(),
                new StartEndCommand(arm::retract, arm::stop, arm).withTimeout(2),
                new InstantCommand(
                        () -> {
