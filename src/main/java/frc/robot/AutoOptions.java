...
public class AutoOptions {
        ...
        public AutoOptions(
                ...
                autoOptions.addOption(
                                ...
                                new MecanumPathFollower(
                                                drive, "Straight 180 degree turning path",
                                                Constants.SlowAutoConstraints, true));
                autoOptions.addOption(
                                "45 degree turning path",
                                new MecanumPathFollower(
                                                drive, "45 degree turning path", Constants.MediumAutoConstraints,
                                                true));
                autoOptions.addOption(
                                "Charge Right",
        ...
        public SequentialCommandGroup threePieceAutoLeft() {
                return new SequentialCommandGroup(
                                ...
                                new WaitCommand(1),
                                new MecanumPathFollower(
                                                drive, "SecondDropOffLeftSide", Constants.MediumAutoConstraints,
                                                false));
        }
        ...
        public SequentialCommandGroup twoPieceAutoRight() {
                return new SequentialCommandGroup(
                                ...
                                new WaitCommand(1),
                                new MecanumPathFollower(
                                                drive, "FirstDropOffRightSide", Constants.MediumAutoConstraints,
                                                false));
        }
